...
<div class="container">
        <div class="row mb-3">
        <div class="col col-8">
            <p class="text-center" style="font-size: x-large">Solicitud Buscada</p>

        </div>

                    <a href="/filtrarSolicitudes" class="btn btn-primary" style="color:Black; background-color: #AD7C59; border:#AD7C59">Volver</a>
                </div>
    ...
    <table class="table table-hover" style="background-color:#DBE2E9">
        <thead>
            <tr>
                ...
                <th style="width: 10%" scope="col">Fecha y horaf</th>
            ...
            @if ($solicitud->getOriginal()['pivot_id'] == $numero)
